...
\begin{frame}{Uniform Resource Locator}
  \textcolor{Aquamarine}{http}://\textcolor{Fuchsia}{username}:\textcolor{Magenta}{password}@\textcolor{MidnightBlue}{www}.\textcolor{Periwinkle}{reddit.com}:\textcolor{SeaGreen}{80}\textcolor{LimeGreen}{/r/funny/}?\textcolor{DarkOrchid}{limit=1}
  
  \begin{table}
    \begin{tabular}{r@{\hspace{0.5cm}}p{6cm}}
      \textcolor{Aquamarine}{http} & Protocol \\
      \textcolor{Fuchsia}{username} & Username \\
      \textcolor{Magenta}{password} & Password \\
      \textcolor{MidnightBlue}{www} & Subdomain \\
      \textcolor{Periwinkle}{reddit.com} & Domain \\
      \textcolor{SeaGreen}{80} & Port \\
      \textcolor{LimeGreen}{/r/funny/} & Path \\
